...
- [Getting Started](#getting-started)
  ...
  * [Search Options](#search-options)
    ...
    - [Fixed Strings (`--fixed-strings` option)](#fixed-strings)
    - [Ignore Case (`-i/--ignore-case` option)](#ignore-case)
    - [Limit Output Line Length (`--max-columns` option)](#limit-output-line-length)
