...
bool is_tar(const char* buffer, const std::size_t& bytes_read) {
  ...
  // 
  // at byte offset 257
  static constexpr std::string_view tar_magic_1 = "75\x73\x74\x61\x72\x00\x30\x30";
  static constexpr std::string_view tar_magic_2 = "75\x73\x74\x61\x72\x20\x20\x00";
